...
namespace MultiplayerARPG.MMO
{
    public partial class UIMmoRegister : UIBase
    {
        ...
        public void tryMMORegister()
        {
            ...
            MMOClientInstance.Singleton.RequestSteamRegister(Username, Password, OnFirebaseRegister);
        }

        public void OnFirebaseRegister(ResponseHandlerData responseHandler, AckResponseCode responseCode, ResponseSteamAuthLoginMessage response)
        {
            Registering = false;
